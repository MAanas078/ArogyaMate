...
const paymentStripe = async (req, res) => {
    try {
        ...
        if (!appointmentData.amount || isNaN(appointmentData.amount)) {
            console.log("appointmentData.amount is invalid:", appointmentData.amount);
        ...
        const session = await stripeInstance.checkout.sessions.create({
            success_url: `${baseUrl}/verify?success=true&appointmentId=${appointmentData._id}`,
            cancel_url: `${baseUrl}/verify?success=false&appointmentId=${appointmentData._id}`,
            line_items,
            mode: 'payment',
        });
